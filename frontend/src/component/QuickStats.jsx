  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Backend se data aise assume kar rahe hai:
        // res.data = { totalSpent: 5000, monthlyLimit: 10000, remaining: 5000 }
    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white rounded-2xl p-6 shadow hover:shadow-lg transition flex flex-col justify-between">
          ...
          <h2
            className={`text-2xl font-bold ${remaining < 0 ? "text-red-500" : "text-green-400"
              }`}
          >
            ₹ {remaining}
          </h2>
