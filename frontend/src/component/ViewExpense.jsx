            ...
            <div className="p-6 bg-gray-100 min-h-screen">
                ...
                <div className="bg-white rounded-2xl shadow p-6">
                    ...
                    {[1, 2, 3, 4, 5].map((item) => (
                        <div
                            key={item}
                            className="flex justify-between items-center py-3 border-b last:border-b-0 border-gray-200"
                        >
                    ...
                    {recentExpenses.length > 0 ? (
                        <>
                            ...
                            <p className="text-gray-400 text-sm">
                                ₹ {recentExpenses[0].amount} • {recentExpenses[0].category} •{" "}
                                {new Date(recentExpenses[0].date).toLocaleDateString()}
                            </p>
                        </>
                    ) : (
                    ...
                    <div className="space-y-3">
                        {recentExpenses.map((item) => (
                            ...
                            >
                                ...
                                <p className="text-gray-800 font-bold text-lg">₹ {item.amount}</p>
                            </div>
                        ))}
                    </div>
                ) : (
